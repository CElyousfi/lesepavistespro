...
export const idfDeptContents: IdfDeptContent[] = [
  ...
  },
  {
    ...
    regulations: `La quasi-totalité des Hauts-de-Seine se trouve à l'intérieur de l'A86, donc dans le périmètre de la ZFE du Grand Paris. Les sanctions pour les Crit'Air 3 ont été suspendues pour 2026 ; la suppression des ZFE votée au printemps 2026 a été censurée par le Conseil constitutionnel le 21 mai 2026 : la zone reste en vigueur ; vérifiez les règles en vigueur avant de vous déplacer. Pour un véhicule qui ne circule plus, la question ne se pose pas : l'enlèvement gratuit par un épaviste agréé, avec certificat de destruction, reste la solution la plus rapide.`,
  ...
  },
  {
    ...
    regulations: `Le Val-d'Oise est en dehors du périmètre de la ZFE du Grand Paris : Argenteuil, seule commune du département membre de la Métropole, se trouve elle aussi au-delà de l'A86, qui délimite la zone. Les obligations VHU restent les mêmes partout dans le département : seul un centre agréé peut délivrer un certificat de destruction valable, et l'abandon d'une épave est sanctionné. Nous intervenons gratuitement dans les 184 communes et gérons la déclaration de cession pour destruction.`,
...
export const idfRegionContent: IdfRegionContent = {
  ...
  regulations: `La zone à faibles émissions (ZFE) de la Métropole du Grand Paris couvre Paris et les communes situées à l'intérieur de l'A86, dans les Hauts-de-Seine, la Seine-Saint-Denis et le Val-de-Marne ; la grande couronne (77, 78, 91, 95) est en dehors du périmètre. Son calendrier a évolué en 2026 : les sanctions pour les Crit'Air 3 ont été suspendues pour 2026 ; la suppression des ZFE votée au printemps 2026 a été censurée par le Conseil constitutionnel le 21 mai 2026 : la zone reste en vigueur. Ce qui ne change pas, c'est la réglementation des véhicules hors d'usage : un VHU doit être remis à un centre agréé, qui dépollue, recycle et délivre le certificat de destruction (directive européenne 2000/53/CE) — document que nous remettons le jour de l'enlèvement, avec la déclaration de cession pour destruction. La prime à la conversion nationale a été supprimée en décembre 2024 ; les aides à l'achat d'un véhicule propre (coup de pouce CEE, dispositifs locaux) évoluent chaque année, renseignez-vous avant de compter dessus.`,
...
export const idfDeptHubs: IdfDeptHub[] = [
  ...
  },
  {
    ...
    zfe: `La quasi-totalité des Hauts-de-Seine se trouve à l'intérieur de l'A86, donc dans le périmètre de la zone à faibles émissions du Grand Paris. Les sanctions pour les Crit'Air 3 ont été suspendues pour 2026 ; la suppression des ZFE votée au printemps 2026 a été censurée par le Conseil constitutionnel le 21 mai 2026 : la zone reste en vigueur ; vérifiez les règles en vigueur avant de vous déplacer avec un véhicule ancien. Pour un véhicule qui ne circule plus, la question ne se pose pas : l'enlèvement gratuit par un épaviste agréé, avec certificat de destruction, reste la sortie la plus simple.`,
  ...
  },
  {
    ...
    zfe: `Les communes de Seine-Saint-Denis situées à l'intérieur de l'A86 (Saint-Denis, Aubervilliers, Pantin, Montreuil, Bobigny, Bondy… en tout ou partie) sont dans le périmètre de la zone à faibles émissions du Grand Paris ; celles au-delà (Aulnay-sous-Bois, Sevran, Tremblay-en-France…) ne le sont pas. Le calendrier des restrictions Crit'Air a évolué en 2026 (sanctions suspendues ; la suppression des ZFE votée au printemps 2026 a été censurée par le Conseil constitutionnel le 21 mai 2026 : la zone reste en vigueur). L'abandon d'un véhicule sur la voie publique reste une contravention de 5e classe, et un véhicule ventouse peut être mis en fourrière puis détruit.`,
  ...
  },
  {
    ...
    zfe: `Le Val-d'Oise est en dehors du périmètre de la zone à faibles émissions du Grand Paris : Argenteuil, seule commune du département membre de la Métropole, se trouve elle aussi au-delà de l'A86, qui délimite la zone. Les obligations VHU restent les mêmes partout dans le département : seul un centre agréé peut délivrer un certificat de destruction valable, et l'abandon d'une épave est sanctionné. Nous gérons la déclaration de cession pour destruction le jour de l'enlèvement.`,
