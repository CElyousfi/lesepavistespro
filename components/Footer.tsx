    ...
    <footer className="bg-brand-navy pt-20 pb-28 lg:pb-12">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-neutral-300">09 79 04 94 86<br /><span className="text-neutral-500">7j/7 - 8h à 20h</span></span>
                </li>
                <li className="flex items-start gap-3">
          ...
          {/* Bottom bar */}
          <div className="pt-8 border-t border-white/10 flex flex-col items-center md:flex-row md:justify-between gap-4">
