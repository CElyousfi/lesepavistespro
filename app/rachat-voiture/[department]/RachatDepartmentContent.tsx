            ...
            {hasMoreCities && (
              <div className="text-center mt-8">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-8 py-3 bg-white border-2 border-neutral-300 hover:border-brand-gold text-neutral-700 hover:text-brand-gold rounded-xl font-semibold transition-all hover:shadow-md"
                >
